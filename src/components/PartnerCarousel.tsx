              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div
                      className="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden shrink-0 ring-1 flex items-center justify-center"
                      style={{ background: `hsl(${p.tint} / 0.12)`, borderColor: `hsl(${p.tint} / 0.4)` }}
                    >
                      <img
                        src={p.logo}
                        alt={`${p.name} logo`}
